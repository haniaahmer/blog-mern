        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/blogs" className="text-gray-400 hover:text-white transition-colors">All Blogs</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/category/technology" className="text-gray-400 hover:text-white transition-colors">Technology</a>
              </li>
              <li>
                <a href="/category/lifestyle" className="text-gray-400 hover:text-white transition-colors">Lifestyle</a>
              </li>
              <li>
                <a href="/category/business" className="text-gray-400 hover:text-white transition-colors">Business</a>
              </li>
              <li>
                <a href="/category/health" className="text-gray-400 hover:text-white transition-colors">Health</a>
              </li>
              <li>
                <a href="/category/travel" className="text-gray-400 hover:text-white transition-colors">Travel</a>
              </li>
            </ul>
          </div>
        </div>
