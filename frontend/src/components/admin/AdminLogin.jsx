...
const AdminLogin = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Remove in production or guard with process.env.NODE_ENV === 'development'
    if (process.env.NODE_ENV === 'development') {
      console.log('Login request payload:', trimmedCredentials);
    }

    try {
      const response = await api.post('/auth/admin-login', trimmedCredentials);
      ...
      const destination = roleRoutes[credentials.role] || '/admin/dashboard';
